...
function BuildOnClickPopup()
{
	...
	return ("new Ajax.Updater('ajax_div', '/ajax/popup', {asynchronous:true, evalScripts:true, parameters: this.href }); return false;");
...
function Ok()
{
	...
	for ( var i = 0 ; i < aLinks.length ; i++ )
	{
		...
		if( GetE('cmbTarget').value == 'popup' )
		{
			...
			//SetAttribute( oLink, 'class', "GaryClass" ) ;
		}
		else
		{
